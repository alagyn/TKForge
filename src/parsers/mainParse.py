...
from forgeExceptions import ParseException

from parsers.parseConsts import PARSERS
...
def parseImports(bo: BuildObject, lines: List[str]) -> int:
    ...
    :param bo: The current objects object
    :param lines: List of all stripped input file lines
    :return: The starting index for global parsers
    """
